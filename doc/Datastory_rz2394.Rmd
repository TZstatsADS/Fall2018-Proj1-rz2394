...
```{r}
#Data_parenthood <- merge(demographic[,c("wid","parenthood")], hm_data[,c("wid","hmid")])
#Data_parenthood <- merge(Data_parenthood[,c("hmid","parenthood")],
#                         senselabel[,c("hmid","supersenseLabel")])
#Data_parenthood <- Data_parenthood[grepl(pattern = "^[a-z]+",
#                                         Data_parenthood$supersenseLabel),]
#Data_parenthood_noun <- Data_parenthood[grepl(pattern = "^[n]",
#                                         Data_parenthood$supersenseLabel),]
```
